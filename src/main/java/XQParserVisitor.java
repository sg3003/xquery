...
public interface XQParserVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitPathSlash(@NotNull XQParser.PathSlashContext ctx);
	...
	/**
	 * Visit a parse tree produced by the {@code pathDSlash}
	 * labeled alternative in {@link XQParser#path}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPathDSlash(@NotNull XQParser.PathDSlashContext ctx);
	...
	/**
	 * Visit a parse tree produced by {@link XQParser#xqs}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitXqs(@NotNull XQParser.XqsContext ctx);
	 ...
	 * @return the visitor result
	 */
	T visitPathAp(@NotNull XQParser.PathApContext ctx);
	...
	/**
	 * Visit a parse tree produced by {@link XQParser#list}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitList(@NotNull XQParser.ListContext ctx);
	 ...
	 * @return the visitor result
	 */
	T visitJfor(@NotNull XQParser.JforContext ctx);
	 ...
	 * @return the visitor result
	 */
	T visitJEq(@NotNull XQParser.JEqContext ctx);
	 ...
	 * @return the visitor result
	 */
	T visitJAnd(@NotNull XQParser.JAndContext ctx);
	 ...
	 * @return the visitor result
	 */
	T visitXqJoin(@NotNull XQParser.XqJoinContext ctx);

	/**
	 * Visit a parse tree produced by {@link XQParser#returnJ}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitReturnJ(@NotNull XQParser.ReturnJContext ctx);
	 ...
	 * @return the visitor result
	 */
	T visitJEqS(@NotNull XQParser.JEqSContext ctx);
	 ...
	 * @return the visitor result
	 */
	T visitRewriteXq(@NotNull XQParser.RewriteXqContext ctx);
